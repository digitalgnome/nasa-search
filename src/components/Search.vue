    ...
    <div class="col-xs-12">
      ...
      <div class="row border-style" v-if="imageURL">
        <div class="col-md-6">
          ...
          <p class="original-image"><small><a :href="imageLarge" v-html="imageLarge" target="_blank"></a></small></p>
      ...
      <div class="row border-style" v-else>
        <div class="col-md-6">
          ...
          <p class="original-image"><small><a :href="imageOfDayURL" v-html="imageOfDayURL" target="_blank"></a></small></p>
          <!-- lightbox container hidden with CSS -->
    ...
    methods: {
      startingImage() {
        axios({
          ...
          this.imageOfDayURL = imageStartParsed.hdurl;
